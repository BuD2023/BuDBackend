...
=== 2. 채팅방 검색
.request
include::{snippets}/chat-controller-test/success-search-chat-room-test/http-request.adoc[]
...
.response
include::{snippets}/chat-controller-test/success-search-chat-room-test/http-response.adoc[]

.response field
include::{snippets}/chat-controller-test/success-search-chat-room-test/response-fields.adoc[]


=== 3. 전체 채팅방 읽기
.request
include::{snippets}/chat-controller-test/success-read-chat-room-test/http-request.adoc[]
...
.response
include::{snippets}/chat-controller-test/success-read-chat-room-test/http-response.adoc[]

.response field
include::{snippets}/chat-controller-test/success-read-chat-room-test/response-fields.adoc[]
